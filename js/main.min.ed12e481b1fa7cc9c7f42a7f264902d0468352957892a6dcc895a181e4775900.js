...
count++}})
return count}
function showPopover(count){var src;if(count===1){$('.sky-event-popup .content-box').addClass('one')
src=$items.eq(0).data('img')}else{$items.sort(function(a,b){var aDate=new Date($(a).data('endtime'))
