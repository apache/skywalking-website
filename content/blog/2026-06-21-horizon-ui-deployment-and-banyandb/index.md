...
<img src="/screenshots/horizon-0.7.0/p04-deployment-02-cluster-dashboard.png" alt="The BanyanDB Cluster dashboard — write/query/error KPIs, CPU/memory/disk capacity, and the Containers by Role table." style="max-height:320px;max-width:100%;width:auto;border-radius:4px;">
...
<figure style="display:flex;flex-wrap:wrap;gap:1.1rem;align-items:center;margin:1.5rem 0;">
<img src="/screenshots/horizon-0.7.0/p04-deployment-03-container-dashboard.png" alt="A Container dashboard for a data/liaison node — role-specific ingestion / storage panels on top of the shared CPU / memory / Go-runtime resources." style="max-height:320px;max-width:100%;width:auto;border-radius:4px;">
...
<figure style="display:flex;flex-wrap:wrap;gap:1.1rem;align-items:center;margin:1.5rem 0;">
<img src="/screenshots/horizon-0.7.0/p04-deployment-03-container-lifecycle-dashboard.png" alt="The same Container dashboard opened on the lifecycle sidecar — only its migration-cycle and last-run panels show." style="max-height:320px;max-width:100%;width:auto;border-radius:4px;">
...
<figure style="display:flex;flex-wrap:wrap;gap:1.1rem;align-items:center;margin:1.5rem 0;">
<img src="/screenshots/horizon-0.7.0/p04-deployment-04-group-dashboard.png" alt="The Group dashboard — per-data-model panels for one storage catalog." style="max-height:320px;max-width:100%;width:auto;border-radius:4px;">
