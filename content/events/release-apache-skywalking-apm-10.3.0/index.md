...
SkyWalking 10.3.0 is released. Go to [downloads](/downloads) page to find release tars.

### New Trace Model in BanyanDB 
Optimized the Trace model implementation for BanyanDB 0.9.0, significantly reducing query frequency between OAP and BanyanDB.
Introduced new query views based on the latest query features, greatly reducing page latency.
