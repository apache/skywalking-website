...
!(function () {
  ...
  var e = window.document,
        ...
        var r = "readystatechange",
          a = function () {
            if (o.test(e.readyState))
              return m(e, r, a), t.apply(this, arguments);
          };
        v(e, r, a);
      }
    },
    ...
    z = function (e, o) {
      return (
        "@media(prefers-color-scheme:" + e + "){" + x[g(x, o) ? o : e] + "}"
      );
    },
    y = {
      "comment-discussion": {
    ...
    F = function (e, o, t) {
      ...
      var i = "large" === b(o["data-size"]),
        ...
        d = e.appendChild(
          r("div", { className: "widget" + (i ? " widget-lg" : "") }, [c])
        ),
        s = c.hostname.replace(/\.$/, "");
      if (("." + s).substring(s.length - l.length) !== "." + l)
        return c.removeAttribute("href"), void t(d);
            ...
            : ((o = []),
              s(e.getElementsByTagName("a"), function (e) {
                -1 !==
                  (" " + e.className + " ")
                    .replace(/[ \t\n\f\r]+/g, " ")
                    .indexOf(" github-button ") && o.push(e);
              }),
              o);
        s(t, function (e) {
          G(e, function (o) {
